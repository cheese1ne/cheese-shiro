 ...
 */
@Configuration
public class KafkaClientRegisterConfiguration {

    private static final Logger logger = LoggerFactory.getLogger(KafkaClientRegisterConfiguration.class);
    ...
    @Bean
    public ClientRegister clientRegister(RegisterProp registerProp) {
        KafkaClientRegister register = new KafkaClientRegister(createTemplate());
        register.setService(registerProp.getService());
        logger.info("prepare to initialize KafkaClientRegister");
        return register;
    }
    ...
    public KafkaListenerContainerFactory consumerFactory() {
        ...
        logger.info("prepare to initialize ConcurrentKafkaListenerContainerFactory");
        return factory;
    }
